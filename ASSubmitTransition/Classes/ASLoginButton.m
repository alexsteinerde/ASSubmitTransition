...
#import "ASLoginButton.h"
#import "ASSpinerLayer.h"

@interface ASLoginButton ()
...
@property (nonatomic, strong) ASAnimationCompletion animationCompletion;

@property (nonatomic, strong) UIColor *color;

@property (nonatomic, strong) ASSpinerLayer *spinerLayer;

@end

@implementation ASLoginButton

-(instancetype) initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        _spinerLayer = [[ASSpinerLayer alloc] initWithFrame:self.frame];
